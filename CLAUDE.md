...
npm install framer-motion @dnd-kit/core @dnd-kit/sortable zustand chrono-node date-fns fuse.js lucide-react nanoid clsx
npm install -D tailwindcss autoprefixer eslint prettier lint-staged husky vitest @testing-library/react @testing-library/user-event @vitejs/plugin-react
```
